...
const SKILLS = {
  // ── COMBAT ──
  muscle_memory:       {icon:'⚔',color:'red',max:3,text:{name:'Muscle Memory',desc:'Increases fast attack damage.',ranks:['Fast atk dmg +5%; AP gain +1%','Fast atk dmg +10%; AP gain +2%','Fast atk dmg +15%; AP gain +3%']}},
  precise_blows:       {icon:'🎯',color:'red',max:3,text:{name:'Precise Blows',desc:'Increases fast attack critical hit chance and damage.',ranks:['Fast crit +2%, crit dmg +15%; AP +1%','Fast crit +4%, crit dmg +30%; AP +2%','Fast crit +6%, crit dmg +45%; AP +3%']}},
  whirl:               {icon:'🌀',color:'red',max:3,text:{name:'Whirl',desc:'Alternate fast attack: spinning strike hitting all nearby foes. Costs Stamina and Adrenaline.',ranks:['Whirl enabled; AP gain +1%','Stamina cost −10%; AP gain +2%','Stamina cost −20%; AP gain +3%']}},
  crippling_strikes:   {icon:'🩸',color:'red',max:3,text:{name:'Crippling Strikes',desc:'Fast attacks apply Bleeding. Affected enemies lose 25 Vitality per second for 5 seconds.',ranks:['Bleed on fast atk; AP +1%','Bleed dmg +50%; AP +2%','Bleed duration +3s; AP +3%']}},

  strength_training:   {icon:'💪',color:'red',max:3,text:{name:'Strength Training',desc:'Increases strong attack damage.',ranks:['Strong atk dmg +5%; AP +1%','Strong atk dmg +10%; AP +2%','Strong atk dmg +15%; AP +3%']}},
  crushing_blows:      {icon:'🔨',color:'red',max:3,text:{name:'Crushing Blows',desc:'Increases strong attack critical hit chance and damage.',ranks:['Strong crit +2%, crit dmg +15%; AP +1%','Strong crit +4%, crit dmg +30%; AP +2%','Strong crit +6%, crit dmg +45%; AP +3%']}},
  rend:                {icon:'🗡',color:'red',max:3,text:{name:'Rend',desc:'Charged strong attack — deals bonus damage proportional to Stamina consumed, ignores defense, +10% crit. AP increases total damage by 100%.',ranks:['Rend enabled; AP +1%','Rend range +1m; AP +2%','Charge speed +25%; AP +3%']}},
  sunder_armor:        {icon:'⚙',color:'red',max:3,text:{name:'Sunder Armor',desc:'Strong attacks permanently reduce enemy damage resistance by 5% per hit.',ranks:['Resistance −5% per hit; AP +1%','Resistance −10% per hit; AP +2%','Resistance −15% per hit; AP +3%']}},

  arrow_deflection:    {icon:'🪃',color:'red',max:3,text:{name:'Arrow Deflection',desc:'Deflect arrows while parrying. At higher ranks, deflected arrows stagger then damage the shooter.',ranks:['Deflect arrows; AP +1%','Deflected arrows stagger shooter; AP +2%','Deflected arrows damage shooter; AP +3%']}},
  fleet_footed:        {icon:'💨',color:'red',max:3,text:{name:'Fleet Footed',desc:'Damage received while dodging reduced.',ranks:['Dodge dmg −20%; AP +1%','Dodge dmg −60%; AP +2%','Dodge dmg −100%; AP +3%']}},
  counterattack:       {icon:'🛡',color:'red',max:3,text:{name:'Counterattack',desc:'After a successful counterattack, next attack deals bonus damage.',ranks:['Counterattack dmg +30%; AP +1%','Counterattack dmg +60%; AP +2%','Counterattack dmg +90%; AP +3%']}},
  deadly_precision:    {icon:'☠',color:'red',max:3,text:{name:'Deadly Precision',desc:'Every Adrenaline Point adds to instant-kill chance on enemies.',ranks:['Instant kill +1% per AP; AP +1%','Instant kill +2% per AP; AP +2%','Instant kill +3% per AP; AP +3%']}},

  lightning_reflexes:  {icon:'⚡',color:'red',max:3,text:{name:'Lightning Reflexes',desc:'Time slowed by extra 15% per rank while aiming the crossbow.',ranks:['Slowdown +15%; AP +1%','Slowdown +30%; AP +2%','Slowdown +45%; AP +3%']}},
  cold_blood:          {icon:'🎯',color:'red',max:3,text:{name:'Cold Blood',desc:'Each crossbow bolt that hits generates Adrenaline Points.',ranks:['Hit: +0.04 AP; AP +1%','Hit: +0.06 AP; AP +2%','Hit: +0.08 AP; AP +3%']}},
  anatomical_knowledge:{icon:'🔬',color:'red',max:3,text:{name:'Anatomical Knowledge',desc:'Increases crossbow critical hit chance.',ranks:['Crossbow crit +5%; AP +1%','Crossbow crit +10%; AP +2%','Crossbow crit +15%; AP +3%']}},
  crippling_shot:      {icon:'🏹',color:'red',max:3,text:{name:'Crippling Shot',desc:'Critical crossbow hits disable monster special abilities for 5 seconds.',ranks:['Disable 5s on crit; AP +1%','Disable 7s on crit; AP +2%','Disable 10s on crit; AP +3%']}},

  resolve:             {icon:'🔥',color:'red',max:3,text:{name:'Resolve',desc:'Adrenaline Point loss upon taking damage is reduced.',ranks:['AP loss on hit −20%; AP gen +1%','AP loss on hit −60%; AP gen +2%','AP loss on hit eliminated; AP gen +3%']}},
  undying:             {icon:'💀',color:'red',max:3,text:{name:'Undying',desc:'When Vitality reaches 0, Adrenaline Points are consumed to restore Vitality.',ranks:['Vitality restored based on AP; AP gen +1%','Restore amount ×2; AP gen +2%','Restore amount ×3; AP gen +3%']}},
  razor_focus:         {icon:'🧠',color:'red',max:3,text:{name:'Razor Focus',desc:'Instantly gain 1 AP when entering combat. AP generated by sword blows increased.',ranks:['+1 AP on combat start; sword AP gen +5%; total AP +1%','Sword AP gen +10%; total AP +2%','Sword AP gen +15%; total AP +3%']}},
  flood_of_anger:      {icon:'🌊',color:'red',max:3,text:{name:'Flood of Anger',desc:'Casting a Sign consumes 3 AP to upgrade Sign to highest level and increase Sign intensity.',ranks:['Sign upgraded; intensity +25%; AP +1%','Sign intensity +50%; AP +2%','Sign intensity +75%; AP +3%']}},
  ...
  aard_sweep:          {icon:'🌊',color:'blue',max:3,text:{name:'Aard Sweep',desc:'Alternate mode — Aard blasts in a 360° arc around Geralt.',ranks:['Circle blast; stam regen +0.5/s','Knockdown chance +10%; stam regen +1/s','Knockdown chance +15%; stam regen +1.5/s']}},
  shock_wave:          {icon:'💢',color:'blue',max:3,text:{name:'Shock Wave',desc:'Aard deals damage to knocked-down or staggered enemies.',ranks:['Aard deals 40 damage; stam regen +0.5/s','80 damage; stam regen +1/s','120 damage; stam regen +1.5/s']}},
  ...
  melt_armor:          {icon:'🔥',color:'blue',max:3,text:{name:'Melt Armor',desc:'Igni damage permanently weakens enemy armor. Scales up to 75% reduction.',ranks:['Armor weakened per hit (max 15%); stam regen +0.5/s','Max 45%; stam regen +1/s','Max 75%; stam regen +1.5/s']}},
  firestream:          {icon:'🌋',color:'blue',max:3,text:{name:'Firestream',desc:'Alternate Igni mode — continuous stream of fire instead of burst.',ranks:['Firestream enabled; stam regen +0.5/s','Burn chance +5%; stam regen +1/s','Burn chance +10%; stam regen +1.5/s']}},
  ...
  exploding_shield:    {icon:'💣',color:'blue',max:3,text:{name:'Exploding Shield',desc:'When the Quen shield breaks it explodes, damaging and knocking back nearby enemies.',ranks:['Explosion on break; knockback; stam regen +0.5/s','Explosion dmg +50%; stam regen +1/s','Explosion dmg +100%; stun chance; stam regen +1.5/s']}},
  active_shield:       {icon:'🛡',color:'blue',max:3,text:{name:'Active Shield',desc:'Alternate Quen mode — sustained shield that absorbs damage and restores Vitality. Stamina drains while held.',ranks:['Absorbed dmg → 30% vitality; stam regen +0.5/s','Absorbed dmg → 60% vitality; stam regen +1/s','Absorbed dmg → 100% vitality; no stamina drain while idle; stam regen +1.5/s']}},
  ...
  // ── ALCHEMY ──
  heightened_tolerance:{icon:'🧪',color:'green',max:3,text:{name:'Heightened Tolerance',desc:'Increases the potion overdose threshold.',ranks:['Overdose threshold +1%; potion duration +5%','Overdose threshold +2%; duration +10%','Overdose threshold +3%; duration +15%']}},
  refreshment:         {icon:'💧',color:'green',max:3,text:{name:'Refreshment',desc:'Each potion dose ingested heals a percentage of max Vitality.',ranks:['Heal 5% max Vitality; duration +5%','Heal 10%; duration +10%','Heal 15%; duration +15%']}},
  delayed_recovery:    {icon:'⏳',color:'green',max:3,text:{name:'Delayed Recovery',desc:'Potion effects do not expire until toxicity drops below a threshold. Buffed in Next Gen.',ranks:['Active until tox <90%; duration +5%','Active until tox <70%; duration +10%','Active until tox <55%; duration +15%']}},
  ...
  poisoned_blades:     {icon:'🐍',color:'green',max:3,text:{name:'Poisoned Blades',desc:'Oil applied to blades gives a chance to poison the target on each hit.',ranks:['3% poison chance; duration +5%','6% poison chance; duration +10%','9% poison chance; duration +15%']}},
  protective_coating:  {icon:'🛡',color:'green',max:3,text:{name:'Protective Coating',desc:'Applying an oil grants resistance to attacks from the matching monster type.',ranks:['+5% resistance while oil applied; duration +5%','+10%; duration +10%','+15%; duration +15%']}},
  fixative:            {icon:'🔒',color:'green',max:3,text:{name:'Fixative',desc:'Oils applied to blades have greatly increased charges; at max rank they do not wear off.',ranks:['Oil charges ×1.33; duration +5%','Oil charges ×1.67; duration +10%','Oils do not wear off; duration +15%']}},
  ...
  steady_aim:          {icon:'⌚',color:'green',max:3,text:{name:'Steady Aim',desc:'Time slows while aiming bombs, making precise throws easier.',ranks:['Time slowed 15% while aiming; duration +5%','Slowed 30%; duration +10%','Slowed 45%; duration +15%']}},
  pyrotechnics:        {icon:'💣',color:'green',max:3,text:{name:'Pyrotechnics',desc:'Non-damaging bombs now deal additional damage on top of their effects.',ranks:['Non-dmg bombs +30 dmg; duration +5%','+60 dmg; duration +10%','+90 dmg; duration +15%']}},
  ...
  acquired_tolerance:  {icon:'⚗',color:'green',max:3,text:{name:'Acquired Tolerance',desc:'Every known alchemy formula increases maximum Toxicity by 1.',ranks:['Each known Lvl1 formula +1 tox; duration +5%','Lvl1 & Lvl2 formulas +1; duration +10%','All formulas (any level) +1; duration +15%']}},
  tissue_transmutation:{icon:'🧬',color:'green',max:3,text:{name:'Tissue Transmutation',desc:'Consuming a mutagen decoction increases maximum Vitality for the decoction\'s duration.',ranks:['+200 max Vitality during decoction; duration +5%','+400 max Vitality; duration +10%','+600 max Vitality; duration +15%']}},
  ...
  frenzy:              {icon:'😈',color:'green',max:3,text:{name:'Frenzy',desc:'If Toxicity > 0, time automatically slows when an enemy is about to counterattack.',ranks:['Slow enabled when tox >0; duration +5%','Slow effect stronger; duration +10%','Slow effect maximized; duration +15%']}},
  endure_pain:         {icon:'💪',color:'green',max:3,text:{name:'Endure Pain',desc:'Increases maximum Vitality when Toxicity exceeds the safe threshold.',ranks:['Vitality +10% over threshold; duration +5%','+20%; duration +10%','+30%; duration +15%']}},
...
// ═══════════════════════════════════════════════════════════
const MUTATIONS = [
  {id:'euphoria',types:['alchemy'],text:{name:'Euphoria',desc:'Each toxicity point increases sword damage and Sign intensity by 0.75%.'}},
  {id:'metamorphosis',types:['combat','signs','alchemy'],text:{name:'Metamorphosis',desc:'Critical effects trigger random decoctions for 120s at no toxicity cost (up to 5 simultaneously).'}},
  {id:'piercing_cold',types:['signs'],text:{name:'Piercing Cold',desc:'Aard has 30% freeze chance. Knocked-down + frozen = instant death.'}},
  {id:'mutated_skin',types:['combat','alchemy'],text:{name:'Mutated Skin',desc:'Each AP reduces damage taken by 15% (max 45%).'}},
  {id:'bloodbath',types:['combat'],text:{name:'Bloodbath',desc:'Each kill: +5% attack power until hit (max 250% in 5-stack increments).'}},
  {id:'conductors_magic',types:['signs','combat'],text:{name:'Conductors of Magic',desc:'Sword attacks deal bonus damage equal to a % of Sign intensity.'}},
  {id:'magic_sensibilities',types:['signs'],text:{name:'Magic Sensibilities',desc:'Sword critical hits trigger a random sign effect for free.'}},
  {id:'toxic_blood',types:['alchemy'],text:{name:'Toxic Blood',desc:'Taking damage deals toxicity-scaled damage back to the attacker.'}},
];
